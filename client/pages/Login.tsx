    ...
    >
      <div className="w-full max-w-5xl">
        ...
        >
          ...
          >
            ...
            <div className="mb-10">
              ...
              <p
                ...
                style={{ color: "#F4A86C" }}
              >
                Conocimiento con la prevención
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-4 px-6 py-3 rounded-lg border border-[#C0C1C2] mb-6 hover:bg-gray-50 transition-colors"
                style={{ backgroundColor: "#FFFBF8" }}
              >
                <GoogleIcon />
                <span
          ...
          {/* Right section - Background with text */}
          <div
            className="w-1/2 p-8 flex items-center justify-center"
            style={{
              /* �� CAMBIAR IMAGEN AQUÍ: Reemplaza la URL de la imagen de fondo */
              background: `url('https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80') center/cover no-repeat, linear-gradient(89deg, #251509 55.34%, #F38B3E 100.09%)`,
              borderRadius: "0 54px 54px 0",
            }}
          >
            <div className="text-center">
              <div
                className="font-['Noto_Sans_HK'] text-sm font-black mb-4"
                style={{ color: "#F7C297" }}
              >
              ...
              <div
                ...
                style={{ color: "#FFFBF8" }}
              >
                Seguridad y prevención, al alcance de un clic.
              </div>
            </div>
          </div>
        </div>
